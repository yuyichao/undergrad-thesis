...
\end{enumerate}
Moreover, for Lithium-$7$, the trappable $|2, 2\rangle$ state has a negative scattering length making it impossible to create a Bose-Einstein condensate with a large atom number without collapsing. In order to solve the problem, we switch to an optical dipole trap (ODT) and do the final evaporation there.\\
\\
