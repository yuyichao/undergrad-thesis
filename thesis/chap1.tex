...
The wave-function of the condensed atoms is only the same with the single particle ground state wave-function when there is no interaction between atoms. For interacting Bose gas this is no longer true. The
