...
At the end of Laser cooling, the atoms are distributed in different ground states hperfine levels (mostly $F=1$ after gray molasses). In order to transfer into the magnetic trap, the atoms need to be in a trappable state
, need to go to 2, 2 / 2, 1 which are the only trappable states at both low field and high field.\\
